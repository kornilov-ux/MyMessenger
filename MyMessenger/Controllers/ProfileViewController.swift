...
class ProfileViewController: UIViewController {
	...
	override func viewDidLoad() {
			...
			data.append(ProfileViewModel(viewModelType: .logout, // Добавляем ячейку для выхода из аккаунта
										 title: "Log Out",
			...
			tabelView.register(ProfileTableViewCell.self, forCellReuseIdentifier: ProfileTableViewCell.identifier)
